...
const Layout5 = () => (
  ...
  // ═══════════════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════════════════════
// LAYOUT 7 - Dark Green Vertical (from SelectLayout) - WITH BIO & EXPERTISE
// ═══════════════════════════════════════════════════════════════════════════
const Layout7 = () => (
...
// ═══════════════════════════════════════════════════════════════════════════
// LAYOUT 8 - Dark Navy Vertical (from SelectLayout) - WITH BIO & EXPERTISE
// ═══════════════════════════════════════════════════════════════════════════
const Layout8 = () => (
  <div className="w-full font-['Inter'] text-white" style={{ background: '#0f1623' }}>
    <div className="flex flex-col items-center pt-8 pb-4 px-4">
...
// ═══════════════════════════════════════════════════════════════════════════
// LAYOUT 9 - Clean White Vertical (from SelectLayout) - WITH BIO & EXPERTISE
// ═══════════════════════════════════════════════════════════════════════════
const Layout9 = () => (
  <div className="w-full bg-white font-['Inter']">
    <div className="flex flex-col items-center pt-8 pb-4 px-4">
